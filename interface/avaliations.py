...
class Ui_Avaliations(object):
    def setupUi(self, Avaliations):
        ...
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.line)
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.line_ref_ava)
        ...
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.line_luxe_ava)
        ...
        self.formLayout_2.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.line_luxa_ava)
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setObjectName("label_11")
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_11)
        self.line_temp_ava = QtWidgets.QLineEdit(self.centralwidget)
        self.line_temp_ava.setObjectName("line_temp_ava")
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.line_temp_ava)
        self.label_12 = QtWidgets.QLabel(self.centralwidget)
        self.label_12.setObjectName("label_12")
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.label_12)
        self.line_ca_ava = QtWidgets.QLineEdit(self.centralwidget)
        self.line_ca_ava.setObjectName("line_ca_ava")
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.line_ca_ava)
        ...
        Avaliations.setTabOrder(self.line_amb_ava, self.line_ca_ava)
        Avaliations.setTabOrder(self.line_ca_ava, self.line_temp_ava)
        Avaliations.setTabOrder(self.line_temp_ava, self.line_ref_ava)
    ...
    def retranslateUi(self, Avaliations):
        ...
        self.label_11.setText(_translate("Avaliations", "Temperatura (ºC)"))
        self.label_12.setText(_translate("Avaliations", "Climatização do Ambiente"))
